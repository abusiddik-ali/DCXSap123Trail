			...
			<div id="analyzerResult" class="marginBottom">
				...
				<div id="binaryRepresentationPane">
					<table id="extendedBinaryRepresentation">
						<thead id="head">
							<tr id="uuidBasedHeader">
								<th colspan="16">Typecode (bits 0-15)</th>
								<th colspan="4">Cluster<br /> (bits 0-4)</th>
								<th colspan="1">UUID<br />/Cnt<br />
								</th>
								<th colspan="39">Timestamp</th>
								<th colspan="2">Cluster (bits 4-5)</th>
								<th colspan="2">Millicnt</th>
							</tr>
                            <tr id="counterBasedHeader">
                                <th colspan="20">Counter (high bits 44-63)</th>
                                <th colspan="1">UUID<br/>/Cnt<br/></th>
                                <th colspan="28">Counter (low bits 15-42)</th>
                                <th colspan="15">Typecode (bits 0-14)</th>
                            </tr>
							<tr>
