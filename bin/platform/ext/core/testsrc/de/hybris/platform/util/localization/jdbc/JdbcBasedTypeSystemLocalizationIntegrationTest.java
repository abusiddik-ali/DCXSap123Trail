...
{
	protected static final String TEST_TYPECODE = TestItemModel._TYPECODE.toLowerCase(LocaleHelper.getPersistenceLocale());
	...
	private static final String SUBTYPE_TYPECODE = TestItemType2Model._TYPECODE.toLowerCase(LocaleHelper.getPersistenceLocale());

	private static final String TEST_ATTRIBUTE_QUALIFIER = TestItemModel.DOUBLE.toLowerCase(LocaleHelper.getPersistenceLocale());
	...
	private static final String SUBTYPE_ATTRIBUTE_QUALIFIER = TestItemType2Model.DOUBLE.toLowerCase(LocaleHelper.getPersistenceLocale());
	...
	private static final String TEST_ENUM_TYPECODE = TestEnum._TYPECODE.toLowerCase(LocaleHelper.getPersistenceLocale());
	private static final String TEST_ENUM_VALUE_CODE = TestEnum.TESTVALUE2.getCode().toLowerCase(LocaleHelper.getPersistenceLocale());
