...
public class DefaultCronJobHistoryDaoTest extends AbstractCronJobHistoryTest
{
	...
	public void testFindAllCronJobHistoryByJob()
	{
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.stream().skip(2).toArray(CronJobHistoryModel[]::new));
	}
	...
	public void testFindAllCronJobHistoryByUserAndJob()
	{
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.stream().skip(1).toArray(CronJobHistoryModel[]::new));
	}
	...
	public void testFindAllCronJobHistoryByUserAndCronJobStatus()
	{
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.get(0),cronJobHistoryModelList.get(3),cronJobHistoryModelList.get(4));
	}
	...
	public void testFindAllCronJobHistoryByUserAndStartDateAndCronJobStatus()
	{
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.get(0),cronJobHistoryModelList.get(2),cronJobHistoryModelList.get(3));
		// when
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.get(0),cronJobHistoryModelList.get(2),cronJobHistoryModelList.get(3),cronJobHistoryModelList.get(4));
	...
	public void testFindAllCronJobHistoryByCronJobResult()
	{
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.stream().skip(3).toArray(CronJobHistoryModel[]::new));
	...
	public void testFindAllCronJobHistoryByUserAndJobItemTypeAndStartDate()
	{
		...
		assertThat(result).doesNotContain(cronJobHistoryModelList.stream().limit(4).toArray(CronJobHistoryModel[]::new));
	...
	public void testFindAllCronJobHistoryByJobItemType()
	{
		...
		final List<CronJobHistoryModel> originCronJobHistoryModelList = new ArrayList<>(cronJobHistoryModelList);
		...
		// then
		assertThat(result).isNotNull();
		assertThat(result).doesNotContain(originCronJobHistoryModelList.stream().toArray(CronJobHistoryModel[]::new));
		...
		assertThat(result).doesNotContain(cronJobHistoryModel2);
		assertThat(result).doesNotContain(originCronJobHistoryModelList.stream().toArray(CronJobHistoryModel[]::new));
		...
		assertThat(result).doesNotContain(cronJobHistoryModel1);
		assertThat(result).doesNotContain(originCronJobHistoryModelList.stream().toArray(CronJobHistoryModel[]::new));
	...
	public void testFindAllCronJobHistoryByCronJobTypeCode()
	{
		...
		//not included
		final CronJobHistoryModel cjhmNotIncluded = createCronJobHistoryForCronJobTypeCode(CronJobModel.class,
				CompositeJobModel.class);
		...
		assertThat(result).doesNotContain(cjhmNotIncluded);
