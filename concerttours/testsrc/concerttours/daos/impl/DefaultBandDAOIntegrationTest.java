...
public class DefaultBandDAOIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void setup() throws Exception
	{
		try
		{
			...
			new JdbcTemplate(Registry.getCurrentTenant().getDataSource()).equals("CHECKPOINT");
			Thread.sleep(TimeUnit.SECONDS.toMillis(1));
		}
	...
	public void bandDAOTest()
	{
		...
		Assert.assertEquals("band not found", allBands.contains(bandModel));
	...
	@Test
	public void testFindBands_EmptyParam()
	{
		//Calling finBandByCode() with an empty String - returns no results
	...
	public void testfindBands_NullParam()
	{
		...
		bandDAO.findBandsByCode(null); //method's return value nor captured
	}
